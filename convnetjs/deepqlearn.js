...
(function(global) {
  ...
  Brain.prototype = {
    ...
    toJSON: function() {
      var json = {};
      json.temporal_window = this.temporal_window;
      //json.experience_size = this.experience_size;
      /*
      json.start_learn_threshold = this.start_learn_threshold;
      json.gamma = this.gamma;
      
      json.learning_steps_total = this.learning_steps_total;
      json.learning_steps_burnin = this.learning_steps_burnin;
      json.epsilon_min = this.epsilon_min;
      json.epsilon_test_time = this.epsilon_test_time;

      json.random_action_distribution = this.random_action_distribution;
      */
      json.net_inputs = this.net_inputs;
      json.num_states = this.num_states;
      json.num_actions = this.num_actions;
      json.window_size = this.window_size;

      json.state_window = this.state_window;
      json.action_window = this.action_window;
      json.reward_window = this.reward_window;
      json.net_window = this.net_window;

      json.value_net = this.value_net.toJSON();
      //json.tdtrainer = this.tdtrainer.toJSON();
      //json.experience = this.experience;

      json.age = this.age;
      json.forward_passes = this.forward_passes;
      //json.epsilon = this.epsilon;
      //json.latest_reward = this.latest_reward;
      //json.last_input_array = this.last_input_array;
      //json.average_reward_window = this.average_reward_window.toJSON();
      //json.average_loss_window = this.average_loss_window.toJSON();
      //json.learning = this.learning;

      return json;
    },
    fromJSON: function(json) {
      this.temporal_window = json.temporal_window;
      //this.experience_size = json.experience_size;
      /*
      this.start_learn_threshold = json.start_learn_threshold;
      this.gamma = json.gamma;
      
      this.learning_steps_total = json.learning_steps_total;
      this.learning_steps_burnin = json.learning_steps_burnin;
      this.epsilon_min = json.epsilon_min;
      this.epsilon_test_time = json.epsilon_test_time;

      this.random_action_distribution = json.random_action_distribution;
      */
      this.net_inputs = json.net_inputs;
      this.num_states = json.num_states;
      this.num_actions = json.num_actions;
      this.window_size = json.window_size;

      this.state_window = json.state_window;
      this.action_window = json.action_window;
      this.reward_window = json.reward_window;
      this.net_window = json.net_window;

      this.value_net.fromJSON(json.value_net);
      //this.tdtrainer.fromJSON(json.tdtrainer);
      //this.experience = json.experience;

      this.age = json.age;
      this.forward_passes = json.forward_passes;
      //this.epsilon = json.epsilon;
      //this.latest_reward = json.latest_reward;
      //this.last_input_array = json.last_input_array;
      //this.average_reward_window.fromJSON(json.average_reward_window);
      //this.average_loss_window.fromJSON(json.average_loss_window);
      //this.learning = json.learning;
    }
  }
